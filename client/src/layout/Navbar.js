        ...
        <header class="text-gray-600 bg-gray-100  body-font">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <Link to="/" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                    <img src={Logo} width={'50px'} alt="" srcset="" />
                    <span class="ml-3 text-xl">FindFood</span>
                </Link>
                <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                    <div class="pt-2 relative mx-auto text-gray-600">
                        <input onChange={(e) => { setSearch(e.target.value) }} class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
